 ...
 * MIT license
 */
(function(c,a,b){if(typeof define==="function"&&define.amd){define(b)}else{if(typeof exports==="object"){module.exports=b()}else{a[c]=b()}}}("heir",this,function(){var e={inherit:function d(h,j,g){var i=h.prototype=e.createObject(j.prototype);i.constructor=h;if(g||typeof g==="undefined"){i._super=j.prototype}},createObject:Object.create||function b(h){var g=function(){};g.prototype=h;return new g()},mixin:function c(g,h){return e.merge(g.prototype,h)},merge:function f(g,i){var h;for(h in i){if(e.hasOwn(i,h)){g[h]=i[h]}}},hasOwn:function a(g,h){return Object.prototype.hasOwnProperty.call(g,h)}};return e}));
